...
& "the intended recipitent and after that you will able to send file's data." & vbCrLf _
& "The amount of data you can send depend on Network installted.", vbInformation
...
Private Sub tcpClient_Close()
 Label6.Caption = "Connection terminated. Now first click disconnect" & vbCrLf _
...
(ByVal bytesTotal As Long)
    ...
    tcpClient.GetData strData
     ...
     If Client1.WindowState = 1 Then
     Client1.WindowState = 0
    End If
    txtOutput.Text = strData
Command2.Enabled = True
Label6.Caption = "Bytes received: " & bytesTotal
txtSendData.SetFocus
